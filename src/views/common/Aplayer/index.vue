<template>
  <div>
    <aplayer :audio="audio" :lrc-type="1" />
  </div>
</template>
...
export default {
      ...
      audio: [
        {
          ...
          'name': '听妈妈的话',
          'artist': '周杰伦',
          'url': 'http://www.170mv.com/kw/antiserver.kuwo.cn/anti.s?rid=MUSIC_138243&response=res&format=mp3|aac&type=convert_url&br=128kmp3&agent=iPhone&callback=getlink&jpcallback=getlink.mp3', 'cover': 'http://img1.kuwo.cn/star/starheads/240/42/97/3914752958.jpg',
  ...
  methods: {
    // async getMusicList() {
    //   await musicApi.getByPage(this.page).then(res => {
    //     this.audio = res.data
    //   })
    // }
  }
