<template>
  <div>
    <div class="bottom-text">
      <div>
        <span class="span-title">个人论坛 | code-fusheng</span>
        | ©2020 | Created by
        <span class="span-author">code-fusheng</span>
        <br />
        <span class="span-demo">
          <a href="https://beian.miit.gov.cn/">湘ICP备20004440号-1</a>
        </span>
      </div>
    </div>
  </div>
